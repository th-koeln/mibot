...
mibot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running mibot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start mibot locally by running:
...
Then you can interact with mibot by typing `mibot help`.

    mibot> mibot help
    mibot animate me <query> - The same thing as `image me`, except adds [snip]
    mibot help - Displays all of the help commands that mibot knows about.
    ...
